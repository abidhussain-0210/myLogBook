    ...
    <div class="row">
      <div class="col-12  mb-5 mb-lg-0">
        <article class="row mb-5">
          ...
          <div class="col-md-8">
            <h3 class="h5"><a class="post-title" href="{{ route('postElement') }}">Elements That You Can Use To Create A New
            ...
            <p>Heading example Here is example of hedings. You can use this heading by following markdownify rules. For example: use # for heading 1 and use ###### for heading 6. Heading 1 Heading 2 Heading 3 …</p> <a href="{{ route('postElement') }}" class="btn btn-outline-primary">Continue Reading</a>
          </div>
        </article>
        <article class="row mb-5">
          <div class="col-md-4 mb-4 mb-md-0">
          ...
          <div class="col-md-8">
            ...
            <p>It’s no secret that the digital industry is booming. From exciting startups to global brands, companies are reaching out to digital agencies, responding to the new possibilities available. However, …</p> <a href="{{ route('postDetails1') }}" class="btn btn-outline-primary">Continue Reading</a>
          </div>
        </article>
        <article class="row mb-5">
          <div class="col-md-4 mb-4 mb-md-0">
