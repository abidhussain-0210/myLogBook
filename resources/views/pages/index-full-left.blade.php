      ...
      <div class="col-lg-8 order-1 order-lg-2 mb-5 mb-lg-0">
        <article class="row mb-5">
          ...
          <div class="col-12 mx-auto">
            <h3><a class="post-title" href="{{ route('postElement') }}">Elements
        ...
        <article class="row mb-5">
          ...
          <div class="col-12 mx-auto">
            <h3><a class="post-title" href="{{ route('postDetails1') }}">Cheerful
        ...
        <article class="row mb-5">
          ...
          <div class="col-12 mx-auto">
            <h3><a class="post-title" href="{{ route('postDetails2') }}">Cheerful
                        Loving Couple Bakers Drinking Coffee</a></h3>
            <ul class="list-inline post-meta mb-4">
              <li class="list-inline-item"><i class="ti-user mr-2"></i><a href="{{ route('author') }}">John Doe</a>
              </li>
