		...
		<article class="row mb-4">
			...
			<div class="col-12 mb-3">
				<div class="post-slider">
					<img src="assets/images/post/post-6.jpg" class="img-fluid" alt="post-thumb">
					<img src="assets/images/post/post-1.jpg" class="img-fluid" alt="post-thumb">
					<img src="assets/images/post/post-3.jpg" class="img-fluid" alt="post-thumb">
				</div>
			</div>
...
<a href="http://www.example.com">http://www.example.com</a> or <a href="http://www.example.com">http://www.example.com</a> and sometimes example.com (but not on Github, for example).</p>
					...
					<div class="border border-default collapse-wrapper"> <a class="d-flex p-2 collapse-head" data-toggle="collapse" href="#collapse-1" role="button">
    collapse 1 <i class="ti-plus ml-auto"></i>
					...
					<div class="border border-default collapse-wrapper"> <a class="d-flex p-2 collapse-head" data-toggle="collapse" href="#collapse-2" role="button">
    collapse 2 <i class="ti-plus ml-auto"></i>
					...
					<div class="border border-default collapse-wrapper"> <a class="d-flex p-2 collapse-head" data-toggle="collapse" href="#collapse-3" role="button">
...
<span style="color:#66d9ef">print</span> s
					...
					<p>
						<img src="../../assets/images/post/post-3.jpg" alt="image">
					</p>
					<hr>
