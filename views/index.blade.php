...
<section class="section">
                ...
                <article class="row mb-5">
                    <div class="col-12">
                        <div class="post-slider">
                            ...
                            @else
                            <img loading="lazy" src="/uploads/{{ $product->image }}" alt="post-thumb">
                            @endif
                        </div>
                    </div>
                    <div class="col-12 mx-auto">
   ...
   <div class="widget">
      ...
      <ul class="list-unstyled widget-list">
         <li><a href="#!" class="d-flex">{{ $product->Blog_category }}
               <small class="ml-auto">({{ $product->id }})</small></a>
         </li>
      </ul>
      @empty
      <div class="alert alert-danger">No Record Found</div>
   ...
   <div class="widget">
      ...
      <ul class="list-inline widget-list-inline">
         <li class="list-inline-item"><a href="#!">{{ $product->blog_Tags }}</a>
         </li>
      </ul>
       @empty
      <div class="alert alert-danger">No Record Found</div>
         ...
         <li class="media widget-post align-items-center">
            <a href="{{ route('postElement') }}">
               ...
               <img loading="lazy" class="mr-3" src="/uploads/no-img.jpg">
                @else
               <img loading="lazy" class="mr-3" src="/uploads/{{ $product->image }}">
                @endif
            </a>
