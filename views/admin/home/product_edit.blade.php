  ...
  <div class="container-xxl flex-grow-1 container-p-y">
     ...
     <h4 class="py-3 mb-4">
       <span> Edit Blog</span>
         ...
         <form name="createProduct" id="createProduct" method="POST" action="{{ route('product.update' , $product->id) }}" enctype="multipart/form-data">
              @csrf
              @method('put')
              <div class="col-md-12">
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <input name="blog_title" id="blog_title" type="text" value="{{ $product->blog_title }}" class="form-control" placeholder="Blog Title">
                            @error('blog_title')
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <input type="text" value="{{ $product->blog_Tags }}" placeholder="Tags" name="blog_tags" id="blog_tags" class="form-control tagsinput" 
                            data-a-sign="$" data-role="tagsinput">
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <textarea name="description" id="description" rows="8" class="form-control" placeholder="Descriptions">{{ $product->description }}</textarea>
                            @error('description')
                            <div style="color:red;text-transform: capitalize;font-size: 10px;">{{ $message }}</div>
                            @enderror
                          </div>
