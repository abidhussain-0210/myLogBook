    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="d-flex align-items-start align-items-sm-center gap-4">
          ...
          @else
          <img src="/uploads/{{ $image->image }}" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
          @endif
          @empty
      ...
      <div class="card-body">
        ...
        <form id="UserProfileForm" name="UserProfileForm" method = "POST" action = "{{ route('userProfile.Store') }}" enctype="multipart/form-data">
          @csrf
          <div class="row">
