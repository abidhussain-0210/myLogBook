         ...
         <div class="col-lg-8  mb-5 mb-lg-0">
            ...
            <article class="row mb-5">
               <div class="col-12">
                  ...
                  <p>It’s no secret that the digital industry is booming. From exciting startups to global brands, companies are reaching out to digital agencies, responding to the new possibilities available. However, the industry is fast becoming overcrowded, heaving with agencies offering similar services — on the …</p> <a href="{{ route('postDetails2') }}" class="btn btn-outline-primary">Continue Reading</a>
               </div>
            </article>
         </div>
            {{-- Aside Start Here --}}
