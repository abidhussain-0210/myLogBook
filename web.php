...
//});
    ...
    Route::get('/admin/product/{id}/edit' , [HomeController::class , 'editProduct'])->name('product.edit');
     ...
     //UserProfile
     Route::get('/admin/profile' , [UserProfileController::class , 'profile'])->name('profile');

     Route::get('/admin/profile-setting' , [UserProfileController::class , 'profileSetting'])->name('profileSetting');

     Route::post('/admin/user-profile/store' , [UserProfileController::class , 'userProfileStore'])->name('userProfile.Store');
     
     Route::get('/admin/edit-profile/{id}/edit' , [UserProfileController::class , 'editProfile'])->name('ProfileEdit');

     Route::put('admin/update-profile/{id}' , [UserProfileController::class , 'userProfileUpdate'])->name('profileUpdate');
